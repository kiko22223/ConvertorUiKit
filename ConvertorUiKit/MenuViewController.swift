    ...
    let cells : [MenuTableViewCellDescription] = [
        ...
        MenuTableViewCellDescription(title: "Weight", imageName: "imageKG"
                                     ...
                                     units: Units(units: ["mg","g", "dk", "kg", "q", "T"],
                                                  ...
                                                  ratios: [1, 1000, 10000, 1000000, 100000000, 1000000000 ])),
        MenuTableViewCellDescription(title: "Temperature", imageName: "imageC",gradientStartColor: UIColor.blue, gradientEndColor: UIColor.purple,
                                     units: Units(units: ["J", "Nm", "mJ", "kJ", "Mj", "Gj", "Tj"],
                                                 sections: [Section(title: "Teplota", units: [0, 1, 2, 3, 4, 5, 6])],
                                                 ratios: [1, 1000, 1000, 1000000, 1000000000, 1_000_000_000_000, 1_000_000_000_000_000]))]
